...
export const DEEPSEEK_EVENTS = Object.freeze({
  SUMMARIZE: 'Deepseek: Used summarize',
  REPLY_SUGGESTION: 'Deepseek: Used reply suggestion',
  REPHRASE: 'Deepseek: Used rephrase',
  FIX_SPELLING_AND_GRAMMAR: 'Deepseek: Used fix spelling and grammar',
  SHORTEN: 'Deepseek: Used shorten',
  EXPAND: 'Deepseek: Used expand',
  MAKE_FRIENDLY: 'Deepseek: Used make friendly',
  MAKE_FORMAL: 'Deepseek: Used make formal',
  SIMPLIFY: 'Deepseek: Used simplify',
  APPLY_LABEL_SUGGESTION: 'Deepseek: Apply label from suggestion',
  DISMISS_LABEL_SUGGESTION: 'Deepseek: Dismiss label suggestions',
  ADDED_AI_INTEGRATION_VIA_CTA_BUTTON:
    'Deepseek: Added AI integration via CTA button',
  DISMISS_AI_SUGGESTION: 'Deepseek: Dismiss AI suggestions',
});
